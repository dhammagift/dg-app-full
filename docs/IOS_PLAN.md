...
1. **Включить `DgDownload` в поток загрузки.** Плагин есть и проверен, но страница его пока не
...
2. **Переживание сворачивания и блокировки экрана** — единственное, что не проверяется без
